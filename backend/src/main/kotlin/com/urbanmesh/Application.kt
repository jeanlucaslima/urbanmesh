...
import com.urbanmesh.config.DelegatingTenantCodeInjector
import com.urbanmesh.config.KoinTenantCodeInjector
import com.urbanmesh.models.GraphQLRequest
import com.urbanmesh.plugins.GraphQLAuthentication
import com.urbanmesh.plugins.cachedRequestBody
import com.urbanmesh.plugins.isPublicOperation
import com.urbanmesh.plugins.requestContext
        ...
        install(CORS) {
            ...
            allowedOrigins.forEach { origin ->
                try {
                    ...
                    // - Render service name only: urbanmesh-frontend (append .onrender.com)
