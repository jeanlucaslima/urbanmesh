...
INSERT INTO customers VALUES
  ('C-1001', 'Northstar Labs',   'Software',    'Enterprise', 'Priya Shah',    88, now()),
  ('C-1027', 'AcmeCloud',        'SaaS',        'Enterprise', 'Diego Alvarez', 52, now()),
  ('C-2044', 'Meridian Finance', 'Finance',     'Business',   'Yuki Tanaka',   61, now());
